...
public class GvrReticlePointer : GvrBasePointer
{
    ...
    public override void OnPointerHover(RaycastResult raycastResultResult, bool isInteractive)
    {
        ...
        if (raycastResultResult.gameObject.GetComponent<VRButton>() != null && Input.GetKeyDown(KeyCode.Joystick1Button0))
            raycastResultResult.gameObject.GetComponent<VRButton>().hoverOnUIEvent.Invoke();
    }
